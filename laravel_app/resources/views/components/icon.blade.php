...
@php
    $paths = [
        ...
        // 反復の記号。スプリントに使う
        'sprint' => '<path d="M4 12a8 8 0 0 1 13.7-5.7L20 8"/><path d="M20 4v4h-4"/>'
        ...
        'settings' => '<circle cx="12" cy="12" r="3"/>'
            .'<path d="M12 2.5 13 5l2.5-.6 1.5 2-1.4 2.1L17 11l2.3 1-.6 2.4-2.5.2-.9 2.4 1.6 1.9-1.8 1.7-2.2-1.3-2 1.5-2-1.5-2.2 1.3-1.8-1.7L7.5 17l-.9-2.4-2.5-.2L3.5 12 6 11l.4-2.5L5 6.4l1.5-2L9 5l1-2.5h2Z"/>',
